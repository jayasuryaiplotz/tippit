...
[Require("AndroidManifest.ApplicationElement", "<activity android:name=\"com.cms.ZBarScannerActivity\" android:theme=\"@style/AppTheme\" ></activity>")]
...
public class QrScanner : NativeEventEmitterModule
{
	...
	public QrScanner() : base(true, "QRECEIVED", "QCANCELED", "QERROR", "PermissionReceived", "PermissionDenied")
	{
		...
		_instance = this;
		Uno.UX.Resource.SetGlobalKey(_instance, "QrScanner");
	...
	@{
		...
		intent.putExtra(ZBarScannerActivity.SCAN_BARCODE_FORMAT, new int[]{0});
		return intent;
	@}
